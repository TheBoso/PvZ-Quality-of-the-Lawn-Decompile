...
enum SeedType
{
  ...
  ENUM_AUTO_VALUE(SEED_ZOMBIE_FLAG)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_NEWSPAPER)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_BACKUP_DANCER)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_DUCKY_TUBE)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_SNORKEL)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_BOBSLED)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_DOLPHIN_RIDER)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_JACK_IN_THE_BOX)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_YETI)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_CATAPULT)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_BOSS)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_REDEYE_GARGANTUAR)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_PEA_HEAD)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_WALLNUT_HEAD)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_JALAPENO_HEAD)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_GATLING_HEAD)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_SQUASH_HEAD)
  // ENUM_AUTO_VALUE(SEED_ZOMBIE_SPAWNER)
  ENUM_AUTO_VALUE(SEED_ZOMBIE_TALLNUT_HEAD)
    ...
    ENUM_VALUE(NUM_SEEDS_IN_CHOOSER, SEED_ZOMBIE_TALLNUT_HEAD + 1)
};
